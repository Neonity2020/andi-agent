...
- **形式与总时长**：半天 workshop（4 小时，含 1 次休息），理论讲解 ~50% + 动手练习 ~50%
...
- ✅ `SKILL.md` — skill 主文件（`.agents/skills/coding-agent-training/SKILL.md`）
- ✅ `references/halfday-workshop.md` — 同源副本（半天 workshop 大纲）
